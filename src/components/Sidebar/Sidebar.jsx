            ...
            {userData.role == "trainer" && (
              <li>
                ...
                >
                  ...
                  <span className="ms-3">Trainer Dashboard</span>
                </Link>
              </li>
            )}
            {userData.role == "trainer" && (
              <li>
                ...
                >
                  ...
                  <span className="ms-3">Session Create</span>
                </Link>
              </li>
            )}
            {userData.role == "trainer" && (
              <li>
                ...
                >
                  ...
                  <span className="ms-3">Assign Trainee</span>
                </Link>
              </li>
            )}
            {userData.role == "trainer" && (
              <li>
                ...
                >
                  ...
                  <span className="ms-3">Trainee Room Code</span>
                </Link>
              </li>
            )}
            <li>
